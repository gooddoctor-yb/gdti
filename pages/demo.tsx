...
export default function demo() {
  const data = {
    title1: "BUILDING SEA’S",
    title2: "DIGITAL HEALTH ECOSYSTEM",
    header_image: "/home_001.png",
    company_image1: "/company/image1.png",
    company_image2: "/company/image2.png",
    company_image3: "/company/image3.png",
  };

  //1
  const HomeFormConfig: any = {
    id: "index-page",
    label: "Home Page",
    fields: [
      {
      ...
      },
      {
        ...
        validate: (value, allValues, meta, field) => {
          debugger;
          console.log("🚀 ~ file: home.js ~ line 48 ~ Home ~ field", field);
          console.log("🚀 ~ file: home.js ~ line 48 ~ Home ~ meta", meta);
          console.log("🚀 ~ file: home.js ~ line 48 ~ Home ~ allValues", allValues);
          console.log("🚀 ~ file: home.js ~ line 48 ~ Home ~ value", value);
        },
        // Generate the frontmatter value based on the filename
        parse: (media, media1) => {
          console.log("🚀 ~ file: home.js ~ line 49 ~ Home ~ media1", media1);
          console.log("🚀 ~ file: home.js ~ line 46 ~ Home ~ media", media);

          return `/${media}`;
        },
        // Decide the file upload directory for the post
        uploadDir: (value, value2) => {
          console.log("🚀 ~ file: home.js ~ line 56 ~ Home ~ value2", value2);
          // 调用 API 接口上传图片
          console.log("🚀 ~ file: home.js ~ line 52 ~ Home ~ value", value);
          return "/public/";
        },
        // Generate the src attribute for the preview image.
        previewSrc: (fullSrc) => {
          console.log("🚀 ~ file: home.js ~ line 50 ~ Home ~ fullSrc", fullSrc.header_image);
          return fullSrc.header_image.replace("/public", "");
          // return fullSrc
          // return ''
        },
      },
      {
        ...
        // Generate the src attribute for the preview image.
        previewSrc: (fullSrc) => {
          console.log("🚀 ~ file: home.js ~ line 50 ~ Home ~ fullSrc", fullSrc.company_image1);
          return fullSrc.company_image1.replace("/public", "");
          // return fullSrc
          // return ''
        },
      },
      {
        ...
        // Generate the src attribute for the preview image.
        previewSrc: (fullSrc) => {
          console.log("🚀 ~ file: home.js ~ line 50 ~ Home ~ fullSrc", fullSrc.company_image2);
          return fullSrc.company_image2.replace("/public", "");
          // return fullSrc
          // return ''
        },
      },
      {
        ...
        // Generate the src attribute for the preview image.
        previewSrc: (fullSrc) => {
          console.log("🚀 ~ file: home.js ~ line 50 ~ Home ~ fullSrc", fullSrc.company_image3);
          return fullSrc.company_image3.replace("/public", "");
          // return fullSrc
          // return ''
        },
      },
  ...
  //2
  const [editableData, form] = useForm(HomeFormConfig);
  usePlugin(form);
        ...
        <div className="grid grid-cols-12 gap-3 auto-cols-fr mt-32">
          <div className="col-start-2 col-end-6 z-30">
            <div className="text-homeBanner leading-header w-96 font-bold text-white">
              <span className="font-thin">{editableData.title1}</span>
              <div>{editableData.title2}</div>
            </div>
          </div>
          <div className="col-start-7 col-end-13 pl-9 relative">
            ...
            <img style={{ marginTop: "400px" }} className="absolute z-10" src={editableData.header_image} />
          </div>
        </div>
