...
const getImageUrl = (data, key) => {
  console.log("🚀 ~ file: home.tsx ~ line 39 ~ getImageUrl ~ data", data[key][0].url)
  return "http://localhost:1337" + data[key][0].url;
  // return typeof data[key] === "string" ? data[key] : data[key]?.previewSrc;
};

export default function Home({ data }) {
  // console.log("🚀 ~ file: home.tsx ~ line 43 ~ Home ~ data", props)
...
export const getStaticProps: GetStaticProps = async function ({ preview, previewData }) {
  ...
  const res = await axios.get("http://localhost:1337/home-page");
